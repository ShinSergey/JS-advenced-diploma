...
export default class GamePlay {
  ...
  redrawPositions(positions) {
    ...
    for (const position of positions) {
      ...
      healthIndicatorEl.classList.add('health-level-indicator', `health-level-indicator-${calcHealthLevel(position.character.value.health)}`);
      healthIndicatorEl.style.width = `${position.character.value.health}%`;
